class RM_Estimator(object):
    ...
    percent_max = {1: 1, 2: 0.95, 3: 0.93, 4: 0.9, 5: 0.87, 6: 0.85,
    ...
    def __init__(self, current_weight, current_reps, desired_reps):
        ...
        if self.current_reps not in self.percent_max or self.desired_reps not in self.percent_max:
    ...
    def estimate_weight(self, base=2.5):
        ...
        estimated_weight = ((self.current_weight/self.percent_max[self.current_reps])
                            * self.percent_max[self.desired_reps])
